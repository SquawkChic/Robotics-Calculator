...
while running:
    ...
    for event in pygame.event.get():
        ...
        if mode in ["torque", "force", "angular_velocity"]:
            for box in inputs:
    ...
    if mode == "menu":
        ...
        draw_text("3. Angular Velocity (w = 2π x RPM / 60)", 60, 230, font, DARK_GRAY)
        ...
        for box in inputs:
            box.draw(screen)
        if mode == "torque":
            draw_text("Force (N):", 250 - font.size("Force (N):")[0] - 10, 105, font)
            draw_text("Radius (m):", 250 - font.size("Radius (m):")[0] - 10, 155, font)

        elif mode == "force":
            draw_text("Mass (kg):", 250 - font.size("Mass (kg):")[0] - 10, 105, font)
            draw_text("Acceleration (m/s²):", 250 - font.size("Acceleration (m/s²):")[0] - 10, 155, font)

        elif mode == "angular_velocity":
            draw_text("RPM:", 250 - font.size("RPM:")[0] - 10, 105, font)
